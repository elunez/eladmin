...
import me.zhengjie.utils.gencode.FilePathStrategy;
import me.zhengjie.utils.gencode.FilePathStrategyFactory;
import me.zhengjie.utils.gencode.FrontFilePathStrategy;
...
public class GenUtil {
    ...
    private static String getAdminFilePath(String templateName, GenConfig genConfig, String className, String rootPath) {
        ...
        if (strategy != null) {
            return strategy.getFilePath(genConfig, className, rootPath);
        }
        return null;
    }
    ...
    private static String getFrontFilePath(String templateName, String apiPath, String path, String apiName) {
        ...
        if (strategy != null) {
            return strategy.getFilePath(apiPath, path, apiName);
        }
        return null;
    }
