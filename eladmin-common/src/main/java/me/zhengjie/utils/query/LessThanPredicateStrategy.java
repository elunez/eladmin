...
public class LessThanPredicateStrategy implements QueryPredicateStrategy {

    @Override
    public Query.Type getQueryType() {
        return Query.Type.LESS_THAN;
    }
    ...
    public Predicate createPredicate(CriteriaBuilder cb, Expression<?> expression, 
        ...
        return cb.lessThanOrEqualTo(expression.as((Class<? extends Comparable>) fieldType), (Comparable) value);
    }
}
