...
public class FindInSetPredicateStrategy implements QueryPredicateStrategy {

    @Override
    public Query.Type getQueryType() {
        return Query.Type.FIND_IN_SET;
    }
    ...
    public Predicate createPredicate(CriteriaBuilder cb, Expression<?> expression, 
        ...
        return cb.greaterThan(cb.function("FIND_IN_SET", Integer.class,
                cb.literal(value.toString()), root.get(attributeName)), 0);
    }
}
