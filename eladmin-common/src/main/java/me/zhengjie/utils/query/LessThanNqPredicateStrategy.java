...
public class LessThanNqPredicateStrategy implements QueryPredicateStrategy {

    @Override
    public Query.Type getQueryType() {
        return Query.Type.LESS_THAN_NQ;
    }
    ...
    public Predicate createPredicate(CriteriaBuilder cb, Expression<?> expression, 
        ...
        return cb.lessThan(expression.as((Class<? extends Comparable>) fieldType), (Comparable) value);
    }
}
