...
public class EqualPredicateStrategy implements QueryPredicateStrategy {

    @Override
    public Query.Type getQueryType() {
        return Query.Type.EQUAL;
    }
    ...
    public Predicate createPredicate(CriteriaBuilder cb, Expression<?> expression, 
        ...
        return cb.equal(expression.as((Class<? extends Comparable>) fieldType), value);
    }
}
